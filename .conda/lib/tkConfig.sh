...
# installed.
TK_PREFIX='/Users/machshren/locCode/open-alpha-trade-in-okx/.conda'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/Users/machshren/locCode/open-alpha-trade-in-okx/.conda'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/Users/machshren/locCode/open-alpha-trade-in-okx/.conda/lib -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/Users/machshren/locCode/open-alpha-trade-in-okx/.conda/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/Users/machshren/locCode/open-alpha-trade-in-okx/.conda/include'
...
# compiled.
TK_SRC_DIR='/Users/machshren/locCode/open-alpha-trade-in-okx/.conda/include'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/Users/machshren/locCode/open-alpha-trade-in-okx/.conda/lib -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Users/machshren/locCode/open-alpha-trade-in-okx/.conda/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/Users/machshren/locCode/open-alpha-trade-in-okx/.conda/lib/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/Users/machshren/locCode/open-alpha-trade-in-okx/.conda/lib/libtkstub8.6.a'
