...
# installed.
TCL_PREFIX='/Users/machshren/locCode/open-alpha-trade-in-okx/.conda'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/Users/machshren/locCode/open-alpha-trade-in-okx/.conda'
...
TCL_EXTRA_CFLAGS='-ftree-vectorize -fPIC -fstack-protector-strong -O2 -pipe -isystem /Users/machshren/locCode/open-alpha-trade-in-okx/.conda/include -fdebug-prefix-map=/Users/runner/miniforge3/conda-bld/tk_1748387499114/work=/usr/local/src/conda/tk-8.6.13 -fdebug-prefix-map=/Users/machshren/locCode/open-alpha-trade-in-okx/.conda=/usr/local/src/conda-prefix -pipe  -D_FORTIFY_SOURCE=2 -isystem /Users/machshren/locCode/open-alpha-trade-in-okx/.conda/include -mmacosx-version-min=11.0 -mmacosx-version-min=11.0 '
...
TCL_LD_FLAGS='-Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/Users/machshren/locCode/open-alpha-trade-in-okx/.conda/lib -L/Users/machshren/locCode/open-alpha-trade-in-okx/.conda/lib -headerpad_max_install_names -Wl,-search_paths_first '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/Users/machshren/locCode/open-alpha-trade-in-okx/.conda/lib -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/Users/machshren/locCode/open-alpha-trade-in-okx/.conda/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/Users/machshren/locCode/open-alpha-trade-in-okx/.conda/include'
...
# compiled.
TCL_SRC_DIR='/Users/machshren/locCode/open-alpha-trade-in-okx/.conda/include'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='{/Users/machshren/locCode/open-alpha-trade-in-okx/.conda/lib} '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/Users/machshren/locCode/open-alpha-trade-in-okx/.conda/lib -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Users/machshren/locCode/open-alpha-trade-in-okx/.conda/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/Users/machshren/locCode/open-alpha-trade-in-okx/.conda/lib/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/Users/machshren/locCode/open-alpha-trade-in-okx/.conda/lib/libtclstub8.6.a'
